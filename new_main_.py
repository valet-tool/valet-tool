...
while pointer:
    ...
    try:
        ...
        with open('ping.csv', 'a') as fd:
            writer = csv.writer(fd)
            writer.writerow([6, 1, 0, end - start])
    ...
    try:
        ...
        with open('ping.csv', 'a') as fd:
            writer = csv.writer(fd)
            writer.writerow([7, 1, 0, end - start])
    ...
    try:
        ...
        with open('ping.csv', 'a') as fd:
            writer = csv.writer(fd)
            writer.writerow([8, 1, 0, end - start])
    ...
    try:
        ...
        with open('ping.csv', 'a') as fd:
            writer = csv.writer(fd)
            writer.writerow([1, 1, 0, end - start])
    ...
    try:
        ...
        with open('ping.csv', 'a') as fd:
            writer = csv.writer(fd)
            writer.writerow([2, 1, 0, end - start])
    ...
    try:
        ...
        with open('ping.csv', 'a') as fd:
            writer = csv.writer(fd)
            writer.writerow([3, 1, 0, end - start])
    ...
    try:
        ...
        with open('ping.csv', 'a') as fd:
            writer = csv.writer(fd)
            writer.writerow([4, 1, 0, end - start])
    ...
    try:
        ...
        with open('ping.csv', 'a') as fd:
            writer = csv.writer(fd)
            writer.writerow([5, 1, 0, end - start])
